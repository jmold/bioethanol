    ...
    <header className="topbar">
      <div className="brand-area">
        ...
        <div className="title-stack">
          ...
          <div className="app-subtitle">Bio-Agri Process Simulator <span>V{appMeta?.version||'0.19.0'} · Model {appMeta?.model_version||'0.19.0'}{isDirty?' · Unsaved changes':''}</span></div>
        </div>
      </div>
